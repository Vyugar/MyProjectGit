...
Чтобы выделить текст курсивом нужно в начале и в конце текста указать символ * или нижнее подчеркивание. Пример:

*Курсив*

_Курсив_

Чтобы выделить текст полужирным нужно в начале и в конце текста указать символ ** или двойное нижнее подчеркивание. Пример:
